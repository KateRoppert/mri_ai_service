 ...
 * Label 1: зелёный (NCR - некротическое ядро)
 * Label 2: жёлтый (ED - отёк)
 * Label 3: жёлтый (NET - неусиливающаяся опухоль)
 * Label 4: красный (ET - усиливающаяся опухоль)
 */
const createSegmentationColormap = () => {
  // Создаём массивы RGBA для каждого label (0-4)
  const colors = {
    R: [0,   0,   255, 255, 255],    // 0: черный, 1: зеленый, 2: желтый, 3: желтый, 4: красный
    G: [0,   255, 255, 255, 0],      // 0: черный, 1: зеленый, 2: желтый, 3: желтый, 4: красный
    B: [0,   0,   0,   0,   0],      // 0: черный, 1: зеленый, 2: желтый, 3: желтый, 4: красный
            ...
            <Space size="large" style={{ fontSize: 13 }}>
              {(lesionType === 'multiple_sclerosis'
                ...
                : [
                    ...
                    { color: 'rgb(255, 255, 0)', label: 'Отёк + неусиливающаяся опухоль (ED/NET)' },
                    { color: 'rgb(255, 0, 0)', label: 'Усиливающаяся опухоль (ET)' },
                  ]
              ).map((item) => (
